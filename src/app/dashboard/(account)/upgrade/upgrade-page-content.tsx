...
export const UpgradePageContent = ({ plan }: { plan: Plan }) => {
  ...
  return (
    <div className="max-w-3xl flex flex-col gap-8">
      <div>
        <h1 className="mt-2 text-xl/8 font-medium tracking-tight text-gray-900 dark:text-gray-100">
          {plan === "PRO" ? "Plan: Pro" : "Plan: Free"}
        </h1>
        <p className="text-sm/6 text-gray-600 max-w-prose dark:text-gray-400">
          {plan === "PRO"
            ? "Thank you for supporting Synch. Find your increased usage limits below."
