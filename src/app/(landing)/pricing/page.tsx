    ...
    <div className="bg-brand-25 py-24 sm:py-32">
      <MaxWidthWrapper>
        <div className="mx-auto max-w-2xl flex flex-col items-center text-center">
          ...
          <p className="mt-6 text-base/7 text-gray-600 dark:text-gray-400 max-w-prose text-pretty">
            We hate subscriptions. And chances are, you do too. That's why we
            offer lifetime access to Synch for a one-time payment.
          </p>
        </div>

        <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
          <div className="p-8 sm:p-10 lg:flex-auto">
            <h3 className="text-3xl font-heading font-semibold tracking-tight text-gray-900 dark:text-gray-100">
              Lifetime access
            </h3>

            <p className="mt-6 text-base/7 text-gray-600 dark:text-gray-400 text-pretty">
              Invest once in Synch and transform how you monitor your SaaS
          ...
          <div className="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
            <div className="rounded-2xl bg-gray-50 dark:bg-slate-900  py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
              <div className="mx-auto max-w-xs py-8">
                ...
                <Button onClick={handleGetAccess} className="mt-6 px-20 dark:text-gray-100">
                  Get Synch
                </Button>
